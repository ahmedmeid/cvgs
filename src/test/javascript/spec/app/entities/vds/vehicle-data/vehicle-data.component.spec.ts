...
import { VehicleDataComponent } from 'app/entities/vds/vehicle-data/vehicle-data.component';
...
describe('Component Tests', () => {
    describe('VehicleData Management Component', () => {
        let comp: VehicleDataComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(VehicleDataComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.vehicleData[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
